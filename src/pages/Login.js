...
export const Login = () => {
  ...
  async function handleLoginGuest() {
    email.current.value = "sipu@gmail.com";
    password.current.value = "sipu1234";
    try{
      const authDetail = {
        email: email.current.value,
        password: password.current.value
